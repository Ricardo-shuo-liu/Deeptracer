...
# 回退一级目录到 deeptracer，然后指向 frontend
FRONTEND_DIR = os.path.join(os.path.dirname(BASE_DIR), "frontend")  # 前端文件目录

#  解决前端跨域问题
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:8571", "http://localhost:5173"], # 允许的前端地址
